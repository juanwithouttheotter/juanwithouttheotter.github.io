    ...
    return (
        <Container fluid="true"  addclass=" my-4" >
            <Row>
                ...
                <Col size="md-8">
                <p>Hello! My name Juan Osorio. and I am an aspiring web developer currently enrolled in Northwestern's
                    ...
                    about myself, my work, and the direction in which I want to drive my future.</p>

                <p>After attempting to make my life easier by creating an automated way of producing my lesson plans
                ...
                <p>
                    I have experience working with RESTful API's, creating and using MySQL databases, creating and working with MongoDB and Mongoose,
                    and building Express applications. I have worked with ES6, ES5, and vanilla javascript, libraries
                    such as jQuery, Bootstrap, Moment.js, and more.
